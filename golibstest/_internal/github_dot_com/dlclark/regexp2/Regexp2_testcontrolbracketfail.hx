...
function testControlBracketFail(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var _inp = (("asdlkcatÿdogiwod" : stdgo.GoString) : stdgo.GoString);
        {
            var __tmp__ = @:check2r _re.matchString(_inp?.__copy__()), _m:Bool = __tmp__._0, __0:stdgo.Error = __tmp__._1;
            if (_m) {
