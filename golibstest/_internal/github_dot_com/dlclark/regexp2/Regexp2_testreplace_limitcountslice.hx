...
function testReplace_LimitCountSlice(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var _myStr = (("aaaaa" : stdgo.GoString) : stdgo.GoString);
        var __tmp__ = @:check2r _re.replace(_myStr?.__copy__(), ("b" : stdgo.GoString), (3 : stdgo.GoInt), (2 : stdgo.GoInt)), _str:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            @:check2r _t.fatalf(("Unexpected err: %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        {
            var __0 = (("aaabb" : stdgo.GoString) : stdgo.GoString), __1 = (_str?.__copy__() : stdgo.GoString);
