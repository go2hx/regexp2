...
function benchmarkMatchClass(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        ...
        var _re = _internal.github_dot_com.dlclark.regexp2.Regexp2_mustcompile.mustCompile(("[abcdw]" : stdgo.GoString), (0 : _internal.github_dot_com.dlclark.regexp2.Regexp2_regexoptions.RegexOptions));
