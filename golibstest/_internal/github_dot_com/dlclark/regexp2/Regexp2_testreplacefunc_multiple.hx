...
function testReplaceFunc_Multiple(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var __tmp__ = @:check2r _re.replaceFunc(("This test is another test for stuff" : stdgo.GoString), function(_m:_internal.github_dot_com.dlclark.regexp2.Regexp2_match.Match):stdgo.GoString {
            _count++;
        ...
        {
            var __0 = (("This 1 is another 2 for stuff" : stdgo.GoString) : stdgo.GoString), __1 = (_str?.__copy__() : stdgo.GoString);
