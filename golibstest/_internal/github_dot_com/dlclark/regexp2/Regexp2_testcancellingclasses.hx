...
function testCancellingClasses(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        var _re = _internal.github_dot_com.dlclark.regexp2.Regexp2_mustcompile.mustCompile(("[\\w\\W\\s]" : stdgo.GoString), (0 : _internal.github_dot_com.dlclark.regexp2.Regexp2_regexoptions.RegexOptions));
        {
...
var _got = __1, _want = __0;
        ...
        {
            var __0 = ((_internal.github_dot_com.dlclark.regexp2.syntax.Syntax_anyclass.anyClass().string() : stdgo.GoString)?.__copy__() : stdgo.GoString), __1 = (((@:checkr (@:checkr (@:checkr _re ?? throw "null pointer dereference")._code ?? throw "null pointer dereference").sets[(0 : stdgo.GoInt)] ?? throw "null pointer dereference").string() : stdgo.GoString)?.__copy__() : stdgo.GoString);
var _got = __1, _want = __0;
            if (_want != (_got)) {
