        ...
        if (!@:check2r _regex.rightToLeft()) {
            ...
            while ((_m != null && ((_m : Dynamic).__nil__ == null || !(_m : Dynamic).__nil__))) {
                ...
                if (_evaluator == null) {
                    ...
                    @:check2r _buf.writeString(_evaluator((_m : _internal.github_dot_com.dlclark.regexp2.Regexp2_match.Match)?.__copy__())?.__copy__());
                };
                _count--;
                if (_count == ((0 : stdgo.GoInt))) {
                    break;
            ...
            while ((_m != null && ((_m : Dynamic).__nil__ == null || !(_m : Dynamic).__nil__))) {
                ...
                if (_evaluator == null) {
                    ...
                    _al = (_al.__append__(_evaluator((_m : _internal.github_dot_com.dlclark.regexp2.Regexp2_match.Match)?.__copy__())?.__copy__()));
                };
                _count--;
                if (_count == ((0 : stdgo.GoInt))) {
                    break;
