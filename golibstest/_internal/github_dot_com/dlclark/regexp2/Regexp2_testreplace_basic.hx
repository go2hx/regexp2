...
function testReplace_Basic(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var __tmp__ = @:check2r _re.replace(("this is a test" : stdgo.GoString), ("unit" : stdgo.GoString), (-1 : stdgo.GoInt), (-1 : stdgo.GoInt)), _str:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
