...
function _isUnsafePointer(_typ:stdgo._internal.go.types.Types_type_.Type_):Bool {
        ...
        return ((_t != null && ((_t : Dynamic).__nil__ == null || !(_t : Dynamic).__nil__)) && ((@:checkr _t ?? throw "null pointer dereference")._kind == (18 : stdgo._internal.go.types.Types_basickind.BasicKind)) : Bool);
    }
