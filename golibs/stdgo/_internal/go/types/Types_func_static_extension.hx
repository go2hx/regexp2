...
@:keep @:allow(stdgo._internal.go.types.Types.Func_asInterface) class Func_static_extension {
    ...
    static public function _hasPtrRecv( _obj:stdgo.Ref<stdgo._internal.go.types.Types_func.Func>):Bool {
        @:recv var _obj:stdgo.Ref<stdgo._internal.go.types.Types_func.Func> = _obj;
        {
            ...
            if (((_sig != null && ((_sig : Dynamic).__nil__ == null || !(_sig : Dynamic).__nil__)) && ((@:checkr _sig ?? throw "null pointer dereference")._recv != null && (((@:checkr _sig ?? throw "null pointer dereference")._recv : Dynamic).__nil__ == null || !((@:checkr _sig ?? throw "null pointer dereference")._recv : Dynamic).__nil__)) : Bool)) {
    ...
    static public function origin( _obj:stdgo.Ref<stdgo._internal.go.types.Types_func.Func>):stdgo.Ref<stdgo._internal.go.types.Types_func.Func> {
        @:recv var _obj:stdgo.Ref<stdgo._internal.go.types.Types_func.Func> = _obj;
        if (((@:checkr _obj ?? throw "null pointer dereference")._origin != null && (((@:checkr _obj ?? throw "null pointer dereference")._origin : Dynamic).__nil__ == null || !((@:checkr _obj ?? throw "null pointer dereference")._origin : Dynamic).__nil__))) {
