    ...
    static public function isAlias( _obj:stdgo.Ref<stdgo._internal.go.types.Types_typename.TypeName>):Bool {
        @:recv var _obj:stdgo.Ref<stdgo._internal.go.types.Types_typename.TypeName> = _obj;
        {
            ...
            if (__type__ == null) {
                ...
                return (((((@:checkr _obj ?? throw "null pointer dereference")._object._pkg != null && (((@:checkr _obj ?? throw "null pointer dereference")._object._pkg : Dynamic).__nil__ == null || !((@:checkr _obj ?? throw "null pointer dereference")._object._pkg : Dynamic).__nil__)) || (@:checkr _t ?? throw "null pointer dereference")._name != ((@:checkr _obj ?? throw "null pointer dereference")._object._name) : Bool) || stdgo.Go.toInterface(stdgo.Go.asInterface(_t)) == (stdgo.Go.toInterface(stdgo._internal.go.types.Types__universebyte._universeByte)) : Bool) || (stdgo.Go.toInterface(stdgo.Go.asInterface(_t)) == stdgo.Go.toInterface(stdgo._internal.go.types.Types__universerune._universeRune)) : Bool);
