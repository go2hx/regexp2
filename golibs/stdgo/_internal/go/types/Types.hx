...
x.set((35 : stdgo._internal.go.token.Token_token.Token), stdgo._internal.go.types.Types__allboolean._allBoolean);
            ...
            stdgo._internal.go.types.Types__universeiota._universeIota = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("iota" : stdgo.GoString));
            stdgo._internal.go.types.Types__universebyte._universeByte = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("byte" : stdgo.GoString)).type();
            stdgo._internal.go.types.Types__universerune._universeRune = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("rune" : stdgo.GoString)).type();
            stdgo._internal.go.types.Types__universeany._universeAny = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("any" : stdgo.GoString));
            stdgo._internal.go.types.Types__universeerror._universeError = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("error" : stdgo.GoString)).type();
            stdgo._internal.go.types.Types__universecomparable._universeComparable = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("comparable" : stdgo.GoString));
