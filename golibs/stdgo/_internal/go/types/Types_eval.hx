...
function eval(_fset:stdgo.Ref<stdgo._internal.go.token.Token_fileset.FileSet>, _pkg:stdgo.Ref<stdgo._internal.go.types.Types_package.Package>, _pos:stdgo._internal.go.token.Token_pos.Pos, _expr:stdgo.GoString):{ var _0 : stdgo._internal.go.types.Types_typeandvalue.TypeAndValue; var _1 : stdgo.Error; } {
        ...
        if (_err != null) {
            return {
                final __tmp__:{ var _0 : stdgo._internal.go.types.Types_typeandvalue.TypeAndValue; var _1 : stdgo.Error; } = { _0 : (new stdgo._internal.go.types.Types_typeandvalue.TypeAndValue() : stdgo._internal.go.types.Types_typeandvalue.TypeAndValue), _1 : _err };
                _0 = __tmp__._0;
                _err = __tmp__._1;
                __tmp__;
            };
        ...
        return {
            final __tmp__:{ var _0 : stdgo._internal.go.types.Types_typeandvalue.TypeAndValue; var _1 : stdgo.Error; } = { _0 : ((@:checkr _info ?? throw "null pointer dereference").types[_node] ?? ({} : stdgo._internal.go.types.Types_typeandvalue.TypeAndValue))?.__copy__(), _1 : _err };
            _0 = __tmp__._0;
            _err = __tmp__._1;
            __tmp__;
        };
