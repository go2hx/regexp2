...
function _isTyped(_t:stdgo._internal.go.types.Types_type_.Type_):Bool {
        ...
        return ((_b == null || (_b : Dynamic).__nil__) || (((@:checkr _b ?? throw "null pointer dereference")._info & (64 : stdgo._internal.go.types.Types_basicinfo.BasicInfo) : stdgo._internal.go.types.Types_basicinfo.BasicInfo) == (0 : stdgo._internal.go.types.Types_basicinfo.BasicInfo)) : Bool);
    }
