...
function testContextHashCollisions(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var __0:stdgo._internal.go.types.Types_type_.Type_ = (null : stdgo._internal.go.types.Types_type_.Type_), __1:stdgo._internal.go.types.Types_type_.Type_ = (null : stdgo._internal.go.types.Types_type_.Type_), __2:stdgo._internal.go.types.Types_type_.Type_ = (null : stdgo._internal.go.types.Types_type_.Type_);
var _unaryP = __2, _nullaryQ = __1, _nullaryP = __0;
        {
