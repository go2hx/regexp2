...
class Checker_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function _collectTypeParams(_dst:stdgo.Ref<stdgo.Ref<stdgo._internal.go.types.Types_typeparamlist.TypeParamList>>, _list:stdgo.Ref<stdgo._internal.go.ast.Ast_fieldlist.FieldList>):Void @:_0 __self__.value._collectTypeParams(_dst, _list);
    @:keep
    @:tdfield
