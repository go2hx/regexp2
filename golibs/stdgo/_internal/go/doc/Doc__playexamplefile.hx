...
function _playExampleFile(_file:stdgo.Ref<stdgo._internal.go.ast.Ast_file.File>):stdgo.Ref<stdgo._internal.go.ast.Ast_file.File> {
        ...
        if ((((_comments.length) > (0 : stdgo.GoInt) : Bool) && stdgo._internal.strings.Strings_hasprefix.hasPrefix(@:check2r _comments[(0 : stdgo.GoInt)].text()?.__copy__(), ("Copyright" : stdgo.GoString)) : Bool)) {
