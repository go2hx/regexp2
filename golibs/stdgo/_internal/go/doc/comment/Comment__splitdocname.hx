...
function _splitDocName(_text:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; } {
        ...
        if (!stdgo._internal.go.doc.comment.Comment__isname._isName(_name?.__copy__())) {
            return {
                final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : _text?.__copy__(), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : false };
                _before = __tmp__._0;
                _name = __tmp__._1;
        ...
        return {
            final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : _before?.__copy__(), _1 : _name?.__copy__(), _2 : true };
            _before = __tmp__._0;
            _name = __tmp__._1;
            _foundDot = __tmp__._2;
            __tmp__;
