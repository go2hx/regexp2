...
@:keep @:allow(stdgo._internal.go.ast.Ast.CommentMap_asInterface) class CommentMap_static_extension {
    ...
    @:keep
    @:tdfield
    static public function update( _cmap:stdgo._internal.go.ast.Ast_commentmap.CommentMap, _old:stdgo._internal.go.ast.Ast_node.Node, _new:stdgo._internal.go.ast.Ast_node.Node):stdgo._internal.go.ast.Ast_node.Node {
        @:recv var _cmap:stdgo._internal.go.ast.Ast_commentmap.CommentMap = _cmap;
        {
            ...
            if (((_list.length) > (0 : stdgo.GoInt) : Bool)) {
                ...
                _cmap[_new] = ((_cmap[_new] ?? (null : stdgo.Slice<stdgo.Ref<stdgo._internal.go.ast.Ast_commentgroup.CommentGroup>>)).__append__(...(_list : Array<stdgo.Ref<stdgo._internal.go.ast.Ast_commentgroup.CommentGroup>>)));
            };
        };
        return _new;
    }
