...
class CommentMap_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function update(_old:stdgo._internal.go.ast.Ast_node.Node, _new:stdgo._internal.go.ast.Ast_node.Node):stdgo._internal.go.ast.Ast_node.Node return @:_0 __self__.value.update(_old, _new);
    @:keep
    @:tdfield
