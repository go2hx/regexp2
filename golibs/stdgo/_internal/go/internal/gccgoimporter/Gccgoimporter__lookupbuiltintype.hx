...
function _lookupBuiltinType(_typ:stdgo.GoInt):stdgo._internal.go.types.Types_type_.Type_ {
        return {
            ...
            s[19] = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("error" : stdgo.GoString)).type();
            s[20] = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("byte" : stdgo.GoString)).type();
            s[21] = @:check2r stdgo._internal.go.types.Types_universe.universe.lookup(("rune" : stdgo.GoString)).type();
            s;
        }[(_typ : stdgo.GoInt)];
    }
