...
function float32Val(_x:stdgo._internal.go.constant.Constant_value.Value):{ var _0 : stdgo.GoFloat32; var _1 : Bool; } {
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo._internal.go.constant.Constant_t_int64val.T_int64Val))) {
                ...
                var __tmp__ = @:check2r @:check2r stdgo._internal.go.constant.Constant__newfloat._newFloat().setInt(_x._val).float32(), _f:stdgo.GoFloat32 = __tmp__._0, _acc:stdgo._internal.math.big.Big_accuracy.Accuracy = __tmp__._1;
                ...
                return @:check2r _x._val.float32();
                ...
                var __tmp__ = @:check2r _x._val.float32(), _f:stdgo.GoFloat32 = __tmp__._0, _acc:stdgo._internal.math.big.Big_accuracy.Accuracy = __tmp__._1;
                return { _0 : _f, _1 : _acc == ((0 : stdgo._internal.math.big.Big_accuracy.Accuracy)) };
