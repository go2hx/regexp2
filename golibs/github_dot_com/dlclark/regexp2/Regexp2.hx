...
@:structInit @:using(github_dot_com.dlclark.regexp2.Regexp2.Regexp_static_extension) abstract Regexp(_internal.github_dot_com.dlclark.regexp2.Regexp2_Regexp.Regexp) from _internal.github_dot_com.dlclark.regexp2.Regexp2_Regexp.Regexp to _internal.github_dot_com.dlclark.regexp2.Regexp2_Regexp.Regexp {
    ...
    public var _code(get, set) : Code;
    function get__code():Code return this._code;
    function set__code(v:Code):Code {
    ...
    public function new(?matchTimeout:stdgo._internal.time.Time_Duration.Duration, ?_pattern:String, ?_options:RegexOptions, ?_caps:stdgo.GoMap<stdgo.GoInt, stdgo.GoInt>, ?_capnames:stdgo.GoMap<stdgo.GoString, stdgo.GoInt>, ?_capslist:Array<String>, ?_capsize:StdTypes.Int, ?_code:Code, ?_muRun:stdgo._internal.sync.Sync_Mutex.Mutex, ?_runner:Array<T_runner>) this = new _internal.github_dot_com.dlclark.regexp2.Regexp2_Regexp.Regexp(matchTimeout, (_pattern : stdgo.GoString), _options, (_caps : stdgo.GoMap<stdgo.GoInt, stdgo.GoInt>), (_capnames : stdgo.GoMap<stdgo.GoString, stdgo.GoInt>), ([for (i in _capslist) (i : stdgo.GoString)] : stdgo.Slice<stdgo.GoString>), (_capsize : stdgo.GoInt), (_code : stdgo.Ref<_internal.github_dot_com.dlclark.regexp2.syntax.Syntax_Code.Code>), (_muRun : stdgo.Ref<stdgo._internal.sync.Sync_Mutex.Mutex>), ([for (i in _runner) (i : stdgo.Ref<_internal.github_dot_com.dlclark.regexp2.Regexp2_T_runner.T_runner>)] : stdgo.Slice<stdgo.Ref<_internal.github_dot_com.dlclark.regexp2.Regexp2_T_runner.T_runner>>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(github_dot_com.dlclark.regexp2.Regexp2.T_runner_static_extension) abstract T_runner(_internal.github_dot_com.dlclark.regexp2.Regexp2_T_runner.T_runner) from _internal.github_dot_com.dlclark.regexp2.Regexp2_T_runner.T_runner to _internal.github_dot_com.dlclark.regexp2.Regexp2_T_runner.T_runner {
    ...
    public var _operator(get, set) : InstOp;
    function get__operator():InstOp return this._operator;
    function set__operator(v:InstOp):InstOp {
        this._operator = v;
        return v;
    }
    ...
    public function new(?_re:Regexp, ?_code:Code, ?_runtextstart:StdTypes.Int, ?_runtext:Array<StdTypes.Int>, ?_runtextpos:StdTypes.Int, ?_runtextend:StdTypes.Int, ?_runtrack:Array<StdTypes.Int>, ?_runtrackpos:StdTypes.Int, ?_runstack:Array<StdTypes.Int>, ?_runstackpos:StdTypes.Int, ?_runcrawl:Array<StdTypes.Int>, ?_runcrawlpos:StdTypes.Int, ?_runtrackcount:StdTypes.Int, ?_runmatch:Match, ?_ignoreTimeout:Bool, ?_timeout:stdgo._internal.time.Time_Duration.Duration, ?_deadline:T_fasttime, ?_operator:InstOp, ?_codepos:StdTypes.Int, ?_rightToLeft:Bool, ?_caseInsensitive:Bool) this = new _internal.github_dot_com.dlclark.regexp2.Regexp2_T_runner.T_runner(
...
typedef Code = Dynamic;
typedef InstOp = Dynamic;
